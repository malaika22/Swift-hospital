        ...
        <Sider>
            ...
            <div className="sidebar-container">
                ...
                <div className="menu-container">
                    ...
                    <Menu className="sidebar-menu" selectedKeys={[current]} onClick={handleMenuChange}>
                        <Menu.Item className="menu-item" key="dashboard">
                            <HomeFilled /> <span className="menuItem-title">Dashboard</span>
                        </Menu.Item>
                        <Menu.Item className="menu-item" key="appointment"> 
                            <CalendarFilled /> <span className="menuItem-title">Appointment</span>
                        </Menu.Item>
